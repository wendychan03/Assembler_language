...
scoresresult db 255, 0,090,090,090,090,090,090,090,090,090,090,090,090,090,090,090,090,090;1
   db 095,095,095,095,095,095,090,090,090,090,090,090,090,090,090,090,095;2
    db 080,080,080,080,080,080,080,080,080,080,080,080,080,080,080,080,080;3
    db 075,075,075,075,075,075,090,090,090,090,090,090,090,090,090,090,075;4
    db 100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100;5
    db 075,075,075,075,075,075,075,075,075,075,010,010,010,010,010,010,010;6
    db 010,010,010,010,010,010,010,010,010,010,010,010,010,010,100,100,100;7
    db 100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100;8
    db 020,020,020,020,020,020,020,020,020,080,080,080,080,080,080,080,080;9
    db 100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,100,030,5 dup('|');10
;     ;从ascii码转化为数字的结果，中间无符号，只最后以\结尾
;final db 255, 10,'777$','100$','100$','096$','099$','100$','100$','100$','100$','100$',100 dup('$');加权总成绩的ascii,每个字符串以$结尾,最后加上\
;srank db 255, 10,'01$','02$','03$','03$','04$','05$','06$','07$','08$','09$','10$',100 dup('|')


sname db 255, 18, 'aaaaa$', 'bbbbb$','ccccc$','ddddd$','eeeee$'
...
final db 80, 12,'090$','093$','080$','078$','100$','026$','068$','100$','066$','058$',1 dup('$');加权总成绩的ascii,每个字符串以$结尾,最后加上\
finalresult db 20,0,090,093,080,078,100,026,068,100,066,058,1 dup('|');加权总成绩的十进制，中间无符号，只最后以\结尾
